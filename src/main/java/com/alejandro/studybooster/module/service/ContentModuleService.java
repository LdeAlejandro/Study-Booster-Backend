...
public interface ContentModuleService {
    ...
    public ResponseEntity<Map<String, Object>> createModule(Long subjectId, CreateContentModuleDTO createContentModuleDTO);
    public ResponseEntity<Map<String, Object>> updateModule (Long moduleId, UpdateContentModuleDTO updateContentModuleDTO);
